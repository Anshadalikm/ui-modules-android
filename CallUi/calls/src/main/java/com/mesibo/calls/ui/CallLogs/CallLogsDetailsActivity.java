...
public class CallLogsDetailsActivity extends AppCompatActivity implements Mesibo.MessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getUserProfile
        mUser = Mesibo.getUserProfile(mPID);

        mProfileName.setText(mUser.name);


        ///Set Profile Pic
        String filePath = Mesibo.getUserProfilePicturePath(mUser, Mesibo.FileInfo.TYPE_AUTO);
        ...
        mVideoCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MesiboCallUi.getInstance().callUi(CallLogsDetailsActivity.this, mParameter.profile.address, true);
            }
        });
        ...
        mAudioCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Mesibo.MessageParams mParameter = new Mesibo.MessageParams(mPID, 0, Mesibo.FLAG_DEFAULT, 0);
                MesiboCallUi.getInstance().callUi(CallLogsDetailsActivity.this, mParameter.profile.address, false);
            }
        });
    ...
    public boolean Mesibo_onMessage(Mesibo.MessageParams messageParams, byte[] bytes) {
        ...
        callLogsItem.setName(messageParams.profile.name);
